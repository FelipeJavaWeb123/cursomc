...
@Entity /* Responsavel por identifica a classe que corresponde a uma tabela */
public class Categoria implements Serializable { /* Categoria correspondente a tabela */
	...
	private Integer id; /* Atributos de uma tabela */
	private String nome;
