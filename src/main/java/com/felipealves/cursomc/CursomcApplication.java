...
import com.felipealves.cursomc.domain.ItemPedido;
import com.felipealves.cursomc.domain.Pagamento;
import com.felipealves.cursomc.domain.PagamentoComBoleto;
import com.felipealves.cursomc.domain.PagamentoComCartao;
...
import com.felipealves.cursomc.repositores.ItemPedidoRepository;
import com.felipealves.cursomc.repositores.PagamentoRepository;
...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPgamento.QUITADO, ped1, 6);
		ped1.setPagamento(pagto1);

		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPgamento.PENDENTE, ped2,sdf.parse("20/10/2017 00:00"),null);
